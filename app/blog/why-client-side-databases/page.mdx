...
export const title = "Why Client-Side Databases Matter"
export const description = "The shift towards local-first applications and what it means for developers"
export const date = "2026-06-15"
export const author = "ctrodb team"
export const tags = ["architecture", "local-first", "web"]

export const metadata = {
  title: "Why Client-Side Databases Matter | ctrodb",
  description,
}

<BlogHeader title={title} description={description} date={date} author={author} tags={tags} />

Ten years ago, most web apps followed the same pattern: the browser was a thin client, the server held all the data, and every user action required a round trip. Today that model is breaking down.
