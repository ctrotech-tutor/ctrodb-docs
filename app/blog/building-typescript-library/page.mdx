...
export const title = "From Alpha to v1.0.0: Building a TypeScript Library"
export const description = "Lessons learned from building ctrodb — a zero-dependency client-side database"
export const date = "2026-05-15"
export const author = "ctrodb team"
export const tags = ["typescript", "library-design", "open-source"]

export const metadata = {
  title: "From Alpha to v1.0.0: Building a TypeScript Library | ctrodb",
  description,
}
