...
export const title = "Full-Text Search in the Browser"
export const description = "How ctrodb implements client-side full-text search without external services"
export const date = "2026-06-05"
export const author = "ctrodb team"
export const tags = ["search", "fts", "plugins"]

export const metadata = {
  title: "Full-Text Search in the Browser | ctrodb",
  description,
}
