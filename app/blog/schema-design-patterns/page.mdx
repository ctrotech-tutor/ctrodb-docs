...
export const title = "Schema Design Patterns for Client-Side Apps"
export const description = "Practical patterns for structuring your client-side database schema"
export const date = "2026-05-28"
export const author = "ctrodb team"
export const tags = ["schema", "patterns", "best-practices"]

export const metadata = {
  title: "Schema Design Patterns for Client-Side Apps | ctrodb",
  description,
}
