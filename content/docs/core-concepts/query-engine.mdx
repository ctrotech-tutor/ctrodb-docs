...
Fuzzy substring search (case-insensitive). Requires the [FTS plugin](/docs/plugins/full-text-search)
for full-text indexing; falls back to `String.includes()` without it.
